<main>
    ...
    <a href="<?= CONTROLLERS_ADMIN ?>?action=danhsachbl" class="btn them" style="background-color: var(--main-color) !important">danh sách bình luận
    </a>
    <div class="table-responsive">
        ...
        <tr>
            <td><input onclick="return confirm('bạn muốn xóa theo lua chon');" class="btn btn-danger" type="submit" name="delete_bl_ct" value="Xóa" id="checkall"></td>
        </tr>
        </form>
    </div>
</main>